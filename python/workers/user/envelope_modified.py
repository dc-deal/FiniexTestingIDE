"""
USER Envelope Modified Worker — Modified copy of CORE/envelope for USER namespace testing.
Demonstrates that USER workers are auto-discovered and work alongside CORE workers.
Includes a 'source' metadata field to prove USER code is running, not CORE.
"""
...
class EnvelopeModifiedWorker(AbstractWorker):
    """Envelope/Bollinger Band worker - Bar-based computation (USER modified)"""
