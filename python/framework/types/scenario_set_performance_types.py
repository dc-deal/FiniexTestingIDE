...
REFACTORED: ProfilingData now fully typed instead of Dict[str, Any]
"""
...
class ScenarioPerformanceStats:
    ...
    FULLY TYPED: portfolio_stats, execution_stats, cost_breakdown, profiling_data
    are now strongly-typed dataclasses instead of Dict[str, Any].
    """
    # Scenario metadata
