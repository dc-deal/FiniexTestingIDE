...
def position_to_carry_over(position: Position) -> PositionCarryOver:
    ...
    return PositionCarryOver(
        ...
        protective_broker_ref=position.protective_broker_ref,
        protective_client_order_id=position.protective_client_order_id,
...
def carry_over_to_position(record: PositionCarryOver) -> Position:
    ...
    position = Position(
        ...
        protective_order_id=record.protective_order_id,
        protective_broker_ref=record.protective_broker_ref,
        protective_client_order_id=record.protective_client_order_id,
