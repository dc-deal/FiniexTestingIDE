...
Usage in CI:
    pytest tests/benchmark/test_benchmark_certificate.py

Usage locally (run full benchmark):
    pytest tests/benchmark/test_throughput_regression.py
"""
...
class TestBenchmarkCertificate:
    ...
    def test_report_exists(self):
        ...
        Rationale:
        - When running `pytest tests/benchmark/` locally, this test runs
        ...
        - Local benchmark: pytest tests/benchmark/test_throughput_regression.py -v
        - CI validation:   pytest tests/benchmark/test_benchmark_certificate.py -v
        """
        ...
        if latest_report is None:
            pytest.skip(
                ...
                f"1. Run: pytest tests/benchmark/test_throughput_regression.py -v\n"
    ...
    def test_report_not_expired(self):
        ...
        assert now <= valid_until, (
            ...
            f"\n"
            f"To fix:\n"
            f"1. Run benchmark locally: pytest tests/benchmark/test_throughput_regression.py\n"
    ...
    def test_report_passed(self):
        ...
        if debug_mode:
            pytest.fail(
                ...
                f"  pytest tests/benchmark/test_throughput_regression.py -v\n"
            )
