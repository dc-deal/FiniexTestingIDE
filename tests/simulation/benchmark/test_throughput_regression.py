...
from tests.simulation.benchmark.conftest import BenchmarkRunResult, _save_benchmark_report
...
class TestReportGeneration:
    ...
    def test_zz_save_benchmark_report(
        ...
        The report is saved to tests/simulation/benchmark/reports/ and should
        ...
        print("   git commit -m 'Update benchmark report'")
