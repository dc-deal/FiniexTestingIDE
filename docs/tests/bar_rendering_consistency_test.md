...
- `tests/bar_rendering/conftest.py` — Synthetic tick generators and fixtures
- `tests/bar_rendering/test_renderer_consistency.py` — Consistency test suite

## Running

```bash
pytest tests/bar_rendering/ -v --tb=short
```
