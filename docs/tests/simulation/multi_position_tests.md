...
```python
# tests/simulation/baseline/conftest.py
BASELINE_CONFIG = "backtesting/backtesting_validation_test.json"

# tests/simulation/multi_position/conftest.py
...
pytest tests/simulation/multi_position/ -v

# baseline suite only
pytest tests/simulation/baseline/ -v
