...
```json
{
  ...
  "artifacts": [
    {"source": "runs/simulation/.../scenario_summary.log", "destination": "tests/simulation/benchmark/reports/logs/run_1/scenario_summary.log", "copied_at": "..."},
    {"source": "runs/simulation/.../scenario_global_log.log", "destination": "tests/simulation/benchmark/reports/logs/run_1/scenario_global_log.log", "copied_at": "..."}
  ],
  "warnings": []
}
```
