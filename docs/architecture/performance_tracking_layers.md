...
| [`python/framework/reporting/console/sim_executive_summary.py`](../../python/framework/reporting/console/sim_executive_summary.py) | `Tracking:` status line in the EXECUTION RESULTS block |
