...
> Extracted to [execution_design_decisions.md](execution_design_decisions.md) — historical reasoning behind abstract class design, pseudo-position elimination, fill logic placement, adapter extension strategy.

---

## Batch Data Flow

> Extracted to [batch_data_flow.md](batch_data_flow.md) — three data channels (Process Input, Process Output, Main-Process Only), serialization boundaries, report integration patterns.
